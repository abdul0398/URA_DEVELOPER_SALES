...
export default function UnitTable() {
    ...
    listings = listings.filter((item: any) => item.developerSales[0].soldInMonth > 0)
    if (includeEC != 'All') {
        console.log(includeEC);
        listings = listings.filter((item: any) => {
           return item.propertyType == (includeEC == "EC" ? "Exec Condo" : "Non-Landed")
        })
    }

    listings.sort((a: any, b: any) => b.developerSales[0].soldInMonth - a.developerSales[0].soldInMonth)
    ...
    return (
        <div className="w-1/2 border">
            <h1 className="text-center h-[7%]">Units Sold in Report Month</h1>
            <div className="bg-white w-full h-[93%] overflow-auto px-2">
